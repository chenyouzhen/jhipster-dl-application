...
public class MaterialResource {
    ...
    public List<MaterialDTO> getAllMaterials(@RequestParam(required = false) String filter) {
        if ("bomentryid-is-null".equals(filter)) {
            log.debug("REST request to get all Materials where bomEntryId is null");
            return materialService.findAllWhereBomEntryIdIsNull();
        }
