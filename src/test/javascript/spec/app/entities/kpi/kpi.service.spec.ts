...
describe('Service Tests', () => {
  describe('Kpi Service', () => {
    ...
    let elemDefault: IKpi;
    let expectedResult: IKpi | IKpi[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(KpiService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Kpi(0, currentDate, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Kpi', () => {
        ...
        service.create(new Kpi()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Kpi', () => {
        const returnedFromService = Object.assign(
          {
            resultTime: currentDate.format(DATE_TIME_FORMAT),
            type: 'BBBBBB',
