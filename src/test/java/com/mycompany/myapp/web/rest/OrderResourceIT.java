...
public class OrderResourceIT {
    ...
    public void createOrder() throws Exception {
        ...
        assertThat(testOrder.getBeginTime()).isEqualTo(DEFAULT_BEGIN_TIME);
        assertThat(testOrder.getDeadLine()).isEqualTo(DEFAULT_DEAD_LINE);
    ...
    public void updateOrder() throws Exception {
        ...
        assertThat(testOrder.getBeginTime()).isEqualTo(UPDATED_BEGIN_TIME);
        assertThat(testOrder.getDeadLine()).isEqualTo(UPDATED_DEAD_LINE);
